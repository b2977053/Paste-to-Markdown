...
window.i18nLocales['zh-cn'] = {
  ...
  step4: '按下 <code>Escape</code> 可以重设状态',
  step5: '使用 {editShortcut} 与 {previewShortcut} 切换标签',
  basedOn: '本转换器基于',
  basedOnAfter: ' 进行转换，所有数据都不会传送到后端，请安心使用。',
  styleFrom: '网页样式取自',
  styleFromAfter: ' 网页，并修正些许错误。',
  sourceCode: '本网页源代码位于',
  feedbackPre: '，欢迎到 ',
  issues: 'Issues',
  ...
  themeDark: '深色',
  fullscreenButton: '⛶ 全屏',
  fullscreenButtonTitle: '将编辑器展开为全屏',
  fullscreenExit: '🗗 退出全屏',
  fullscreenExitTitle: '退出全屏模式',
  fullscreenUnsupported: '当前浏览器不支持全屏模式',
  shareButton: '🔗 分享',
  shareButtonTitle: '复制可分享网址',
  shareSuccess: '🔗 已复制链接',
  copyButton: '📋 复制',
  copyButtonTitle: '以 Markdown 与 HTML 复制',
  copySuccess: '📋 已复制',
  placeholder: '粘贴内容...',
  noPreview: '没有内容可预览'
};
