...
window.i18nLocales.fr = {
  ...
  step5: 'Changez d\'onglet avec {editShortcut} et {previewShortcut}',
  ...
  fullscreenButtonTitle: 'Afficher l’éditeur en plein écran',
  fullscreenExit: '🗗 Quitter le plein écran',
  fullscreenExitTitle: 'Quitter le mode plein écran',
  fullscreenUnsupported: 'Ce navigateur ne prend pas en charge le plein écran',
